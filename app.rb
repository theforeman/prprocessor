...
* File a new ticket in the [#{correct_project.name} project](http://projects.theforeman.org/projects/#{repo.redmine_project}/issues/new), update the PR title and the commit message (using `git commit --amend`).
